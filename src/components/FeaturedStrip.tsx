...
const featured = [
  { key: 'proj_body_name', desc: 'proj_body_desc', href: 'https://lemuelowusuansah.github.io/Body-Metrics-01/', number: '01',
  ...
  { key: 'proj_capital_name', desc: 'proj_capital_desc', href: 'https://lemuelowusuansah.github.io/Capital-Quest/', number: '02',
  ...
  { key: 'proj_wellness_name', desc: 'proj_wellness_desc', href: 'https://lemuelowusuansah.github.io/Lans-Wellness-Clinic--Frontend-/', number: '03',
  ...
  { key: 'proj_convertoria_name', desc: 'proj_convertoria_desc', href: 'https://lemuelowusuansah.github.io/Convertoria/', number: '04',
          ...
          <a key={item.key} href={item.href} target="_blank" rel="noopener noreferrer"
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <span className={`mt-auto pt-6 inline-flex items-center gap-2 font-mono text-2xs uppercase tracking-[0.14em] transition-all duration-300 group-hover:gap-3 ${item.muted}`}>
                {t('featured_try_app', 'Try the app')}
